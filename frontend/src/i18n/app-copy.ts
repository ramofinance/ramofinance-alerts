...
export const getAppCopy = (language: PreferredLanguage | null): any => {
  ...
  if (language === "FA") {
    return {
      ...
      radarTelegramHint: "پس از فعال‌سازی، برای دیدن هشدار لازم نیست مینی‌اپ باز باشد.",
  ...
  return {
    ...
    radarTelegramHint: "Once enabled, alerts arrive even while the Mini App is closed.",
