...
export const getAppCopy = (language: PreferredLanguage | null): any => {
  ...
  if (language === "FA") {
    return {
      ...
      radarMinMarketCap: "حداقل مارکت‌کپ", radarMaxMarketCap: "حداکثر مارکت‌کپ", radarMinTurnover: "حداقل حجم/مارکت‌کپ",
      radarMinAcceleration: "حداقل شتاب حجم ۱۵دقیقه", radarMinPriceChange: "حداقل تغییر قیمت ۲۴ساعته", radarMinTrades: "حداقل تعداد معاملات ۲۴ساعته",
      ...
      radarCandidates: "آخرین موارد شناسایی‌شده", radarSources: "داده زنده Binance + CoinGecko",
      radarPrice: "قیمت", radarChange: "تغییر ۲۴ساعت", radarTurnover: "حجم/مارکت‌کپ",
      radarAcceleration: "شتاب حجم ۱۵دقیقه", radarMarketCap: "مارکت‌کپ", radarSource: "منبع",
      ...
      radarReasonTurnover: "حجم ۲۴ساعته معادل {value}٪ مارکت‌کپ است.",
  ...
  return {
    ...
    radarMinMarketCap: "Minimum market cap", radarMaxMarketCap: "Maximum market cap", radarMinTurnover: "Minimum volume/market cap",
    radarMinAcceleration: "Minimum 15m volume acceleration", radarMinPriceChange: "Minimum 24h price change", radarMinTrades: "Minimum 24h trade count",
    ...
    radarCandidates: "Latest detections", radarSources: "Live Binance + CoinGecko data",
    radarPrice: "Price", radarChange: "24h change", radarTurnover: "Volume/market cap",
    radarAcceleration: "15m acceleration", radarMarketCap: "Market cap", radarSource: "Source",
    ...
    radarReasonTurnover: "24h volume equals {value}% of market cap.",
