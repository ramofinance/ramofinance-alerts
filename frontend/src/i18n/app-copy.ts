...
export const getAppCopy = (language: PreferredLanguage | null): any => {
  ...
  if (language === "FA") {
    return {
      ...
      radarTelegramHint: "پس از فعال‌سازی، فقط موارد با حجم حداقل ۱۵٪ مارکت‌کپ ارسال می‌شوند و لازم نیست مینی‌اپ باز باشد.",
  ...
  return {
    ...
    radarTelegramHint: "Alerts require at least 15% volume-to-market-cap turnover and arrive while the Mini App is closed.",
