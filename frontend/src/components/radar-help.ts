export type RadarHelpKey =
  | "notifications" | "minimumScore" | "minMarketCap" | "maxMarketCap" | "minTurnover24h" | "minTurnover72h"
...
const fa: HelpMap = {
  ...
  minimumScore: "حداقل امتیاز نهایی Radar برای ارسال هشدار است. امتیاز از ترکیب حجم، تعداد معاملات، خریداران یکتا، فشار خرید، DEX، مشتقات و آن‌چین ساخته می‌شود. این گزینه ۰ ندارد و همیشه فعال است.",
...
const en: HelpMap = {
  ...
  minimumScore: "Minimum final Radar score required for an alert. The score combines volume, trades, unique DEX buyers, buy pressure, derivatives, DEX and on-chain data. This setting cannot be 0 and is always active.",
